<template>
  <div>
    <nav class="navbar navbar-light navbar-expand-lg fixed-top" id="mainNav">
      <div class="container">
        <a href="/" class="navbar-brand">V8</a
        ><button
    ...
    <!-- Se debe activar el router view para que funcione -->
    <transition name="miTransicion">
...
.miTransicion-enter-active,
.miTransicion-leave-active {
  transition: opacity 0.1s;
}

.miTransicion-enter,
.miTransicion-leave-to {
  opacity: 0;
}
</style>
